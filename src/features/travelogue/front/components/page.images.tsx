...
const ImageSingle = (props: { image: ImageSelect }) => {
	return (
		<Dialog>
			<DialogTrigger className="focus-visible:outline-none aspect-square w-full overflow-hidden rounded-md">
				<img
			...
			<DialogContent className="sm:max-w-3xl p-0 ring-0 rounded-md bg-transparent">
				<img
