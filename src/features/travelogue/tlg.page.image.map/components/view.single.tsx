...
export const TlgPageImageMapViewSingle = (props: {
	imageId: number;
	pageId: number;
}) => {
	...
	const pageImageMapRemoveMutation = useMutation(
		orpc.tlgPageImageMapRouter.remove.mutationOptions({
			onSuccess: async () => {
	...
	return (
		<Attachment orientation={"vertical"}>
			...
			<AttachmentActions>
				<AttachmentAction
					onClick={() =>
						pageImageMapRemoveMutation.mutateAsync({
							pageId: props.pageId,
